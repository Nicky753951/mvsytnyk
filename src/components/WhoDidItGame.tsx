...
const allCards: Card[] = [
  { text: "Залишив холодильник відчиненим на всю ніч", answer: "koля" },
  { text: "Купила 10 пар взуття за один похід у магазин", answer: "віка" },
  { text: "Заснув на дивані під час фільму через 15 хвилин", answer: "koля" },
  { text: "Витратила годину на вибір фільтра для фото", answer: "віка" },
  { text: "З'їв останній шматок торта о 2 годині ночі", answer: "koля" },
  { text: "Зробила 50 селфі перед виходом з дому", answer: "віка" },
  { text: "Загубив ключі від машини в холодильнику", answer: "koля" },
  { text: "Плакала від відео з котиками", answer: "віка" },
  { text: "Забув про річницю і згадав в останній момент", answer: "koля" },
  { text: "Перефарбувала волосся тричі за місяць", answer: "віка" },
  { text: "Зібрав шафу з IKEA без інструкції (і залишилися зайві деталі)", answer: "koля" },
  { text: "Купила ще одну свічку, бо «ця пахне інакше»", answer: "віка" },
  ...
  { text: "Зробила ремонт у квартирі за настроєм", answer: "віка" },
  { text: "Випив молоко прямо з пакета", answer: "koля" },
  { text: "Замовила «тільки каву» і повернулася з трьома пакетами", answer: "віка" },
  { text: "Переплутав сіль з цукром під час готування", answer: "koля" },
  { text: "Сказала «мені нічого не треба» і образилась, що не вгадав", answer: "віка" },
];
