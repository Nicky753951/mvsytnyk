...
const allCards: Card[] = [
  { text: "Написав/написала пісню про другу половинку", answer: "koля" },
  ...
  { text: "Грає на декількох музичних інструментах", answer: "koля" },
  { text: "Знає, як заспокоїти другу половинку одним поглядом або словом", answer: "віка" },
  { text: "Не памʼятає коли востаннє дивився/дивилася телевізор", answer: "koля" },
  { text: "Знає все про Євробачення", answer: "віка" },
  ...
  { text: "Влаштовує вечірні прибирання", answer: "koля" },
  ...
  { text: "Не обговорює плани поки не впевнений/а, що все вийде", answer: "koля" },
