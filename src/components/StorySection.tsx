...
const events = [
  { date: "Вересень 2017", title: "Перша зустріч", text: "Ми зустрілися на весіллі Ігоря та Вікторії (наших теперішніх кумів)." },
  { date: "Січень 2025", title: "Перше побачення", text: "Романтичні вихідні зимовим Києвом, ВДНГ та кава." },
  { date: "Грудень 2025", title: "Пропозиція", text: "В ресторані Villa Riviera Микола зробив пропозицію і Вікторія сказала «Так»!" },
  { date: "Вересень 2026", title: "Наше весілля", text: "Настав час святкувати наше кохання разом з найдорожчими людьми." },
];
