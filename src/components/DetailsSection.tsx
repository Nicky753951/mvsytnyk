...
const program = [
  ...
  { time: "13:30", title: "Церемонія", text: "Візьміть серветки для сліз щастя, попереду дуже чуттєвий момент" },
  { time: "14:30", title: "Святковий банкет", text: "Час смачної їжі, зворушливих тостів і затишної атмосфери" },
  { time: "20:00", title: "Торт", text: "Аромат кави та солодкий десерт – приємна мить цього вечора" },
];
